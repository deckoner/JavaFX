...
public class TextControlProperties extends Application {
	...
	public void start(Stage stage) {
		...
		root.addRow(1, new Label("Caret Postion:"), caretLbl);
		root.addRow(2, new Label("Length:"), lengthLbl);
		root.addRow(3, new Label("Selected Text:"), selectedTextLbl);
		root.addRow(4, new Label("Selection:"), selectionLbl);
		root.addRow(5, new Label("Text:"), textLbl);
